...
<!-- badges: start -->
[![R-CMD-check](https://github.com/tbrown122387/gradeR/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/tbrown122387/gradeR/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
As of 2026, this package can now support R Markdown (`.rmd`) and Quarto (`.qmd`) submissions in addition to standard R scripts (`.R` or `.r`).
